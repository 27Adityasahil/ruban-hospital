...
// import { Play, ArrowRight, Award, Users, Heart, Shield, Calendar, Phone } from 'lucide-react';

// const HeroSection = () => {
//   const achievements = [
//     { icon: Award, number: '25+', text: 'Years Experience', color: 'primary' },
//     { icon: Users, number: '4L+', text: 'Happy Patients', color: 'success' },
//     { icon: Heart, number: '15+', text: 'Specialties', color: 'danger' },
...
//   return (
//     <section className="position-relative overflow-hidden" style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 50%, #f1f5f9 100%)' }}>
//       {/* Background Decorations */}
//       <div className="position-absolute top-0 end-0 opacity-25">
//         <div 
//           className="rounded-circle gradient-primary"
//           style={{ width: '400px', height: '400px', transform: 'translate(40%, -40%)' }}
//         ></div>
//       </div>
...
//                 <span className="small fw-medium">JCI Accredited Multi-Specialty Hospital</span>
//               </div>
...
//               {/* Description */}
//               <p className="lead text-muted mb-5" style={{ fontSize: '1.25rem', lineHeight: '1.7' }}>
//                 Experience world-class healthcare with cutting-edge technology, compassionate care, 
//                 and a team of renowned specialists dedicated to your wellbeing. We deliver excellence 
...
//                 <button className="btn btn-custom text-white px-4 py-3 rounded-pill shadow">
//                   <Calendar size={18} className="me-2" />
//                   Book Appointment
//                   <ArrowRight size={18} className="ms-2" />
//                 </button>
//                 <button className="btn btn-outline-danger px-4 py-3 rounded-pill">
//                   <Phone size={18} className="me-2" />
//                   Emergency: +91 9876543210
//                   <div className="bg-danger rounded-circle d-inline-block ms-2" style={{ width: '8px', height: '8px' }}></div>
//                 </button>
//               </div>
//             </div>
//           </div>
...
//                 {/* Main Image */}
//                 <div className="position-relative rounded-4 overflow-hidden shadow-custom-lg">
//                   <img 
...
//                   {/* Gradient Overlay */}
//                   <div className="position-absolute top-0 start-0 w-100 h-100" style={{ background: 'linear-gradient(45deg, rgba(30, 64, 175, 0.1) 0%, rgba(8, 145, 178, 0.1) 100%)' }}></div>
                  
//                   {/* Play Button */}
//                   <div className="position-absolute top-50 start-50 translate-middle">
//                     <button className="btn btn-light rounded-circle p-4 shadow-lg hover-scale">
//                       <Play size={32} className="text-primary ms-1" />
//                     </button>
//                   </div>

//                   {/* Video Info Card */}
//                   <div className="position-absolute bottom-0 start-0 end-0 m-4">
//                     <div className="card border-0 bg-white bg-opacity-90 backdrop-blur">
//                       <div className="card-body p-3">
//                         <h6 className="mb-1 fw-bold">Virtual Hospital Tour</h6>
//                         <small className="text-muted">Discover our state-of-the-art facilities</small>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                     style={{
//                       [index === 0 ? 'top' : index === 1 ? 'bottom' : 'top']: index === 1 ? '20px' : '60px',
//                       [index === 2 ? 'right' : 'left']: index === 2 ? '-20px' : '-20px',
...
import React from 'react';
import { ArrowRight, Award, Users, Heart, Shield, Calendar, Phone } from 'lucide-react';
        ...
        <div className="row align-items-center min-vh-100">
          ...
          <div className="col-lg-6 mb-5 mb-lg-0">
            <div className="slide-in-left">
              <div className="d-inline-flex align-items-center bg-primary bg-opacity-10 text-primary rounded-pill px-4 py-2 mb-4">
                <Award size={16} className="me-2" />
                <span className="small fw-medium">NABH Accredited Multi-Specialty Hospital</span>
              </div>

              <h1 className="display-3 fw-bold mb-4 font-display">
                Your Health is Our <span className="text-gradient-primary">Priority</span>
              </h1>
              ...
              >
                Experience world-class healthcare with cutting-edge technology, compassionate care,
                and a team of renowned specialists dedicated to your wellbeing. We deliver
                excellence in every aspect of medical care.
              </p>
          ...
          <div className="col-lg-6">
            <div className="slide-in-right">
              <div className="position-relative rounded-4 overflow-hidden shadow-custom-lg" style={{ height: '500px' }}>
                {/* YouTube Video Embed */}
                <iframe
